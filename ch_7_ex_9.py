...
document = "Rapunzel let down her long golden hair" # example sentence
...
print result
document = "every day she goes to university" # example sentence
print ie_preprocess(document)
grammar = r"""
NP:
   {<.*>+}
   ...
   """
sentence = [("every", "DT"), ("day", "NNS"), ("she", "PRP"), ("goes", "VBZ"), ("to", "TO"), ("university", "NN")]
