...
import nltk  
from nltk.corpus import brown #імпортуємо Браунівський корпус
>>> help (nltk.AffixTagger) #викликаємо файл допомоги про AffixTagger
...
sent=('Stephane Hessel the former French Resistance fighter whose 2010 manifesto Time for Outrage inspired social protesters in Europe dies aged 95').split() #Речення, яке будемо використовувати
for i in range(4): #Використання AffixTagger з різними значеннями affix_length та min_stem_length
