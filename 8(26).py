#chapter 8, Ex. 26
#by Ivanna Rurych
# Modify the functions init_wfst()and complete_wfst()so that the contents of each cell in the WFST is a set of non-terminal symbols rather than a single nonterminal.
...
#function which completes cells in the WFST
def complete_wfst(wfst, tokens, grammar, trace=False):
    index = dict((p.rhs(), p.lhs()) for p in grammar.productions()) # list where the left and right sides of all grammar rules are written
