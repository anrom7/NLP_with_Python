...
#CH.7, EX.2
import nltk
pl_nouns=[("many","JJ"),("researchers","NNS"),("two","CD"),("weeks","NNS"), ("both","DT"),("new","JJ"),("positions","NNS")] 
...
result=chunk_parser.parse(pl_nouns) #Test chunk parser on our example sentence
print result  #The result is a tree, which we can either print, 
result.draw() #or display graphically
from nltk.corpus import conll2000 #Access the data of the CoNLL-2000 Chunking Corpus. The corpus contains 270k words of Wall Street Journal text, divided into “train” and “test” portions, annotated with part-of-speech tags and chunk tags in the IOB format.
