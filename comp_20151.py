...
f1=open('D:/Viktoria/KLingva/2semestr/Захист/Positive.txt', encoding='utf-8')
f2=open('D:/Viktoria/KLingva/2semestr/Захист/Negative.txt', encoding='utf-8')
pos_w=[]
...
f3=open('D:/Viktoria/KLingva/2semestr/Захист/rez_domen5.txt', encoding='utf-8')
...
z=open('D:/Viktoria/KLingva/2semestr/Захист/pos_domen_rez5.txt','w')
for i in rez:
	z.write(str(i)+'\n')
z.close()
rez=[]
...
z=open('D:/Viktoria/KLingva/2semestr/Захист/neg_domen_rez5.txt','w')
for i in rez:
	z.write(str(i)+'\n')
z.close()
